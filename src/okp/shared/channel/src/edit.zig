/// This channel dispatches the "edit" message to it's subscribers.
/// Any messenger can send an "edit" message by calling .send.
/// This file was generated by kickzig when you added the "edit" message.
/// It will be removed when you remove the "edit" message.
