...
/// 1. Any front-end messenger can send a "CloseDownJobs" message to the subscribed back-end "CloseDownJobs" messenger.
/// 2. The subscribed back-end "CloseDownJobs" messenger receives each "CloseDownJobs" message sent from any front-end messengers.
